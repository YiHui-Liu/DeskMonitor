...
#define DESKMON_CONFIG_NTP_SERVER_MAX_LEN 64
#define DESKMON_CONFIG_TIMEZONE_MAX_LEN 64

#define DESKMON_CONFIG_DEFAULT_CAROUSEL_SEC 10U
#define DESKMON_CONFIG_MIN_CAROUSEL_SEC 1U
...
#define DESKMON_CONFIG_DEFAULT_WEATHER_REFRESH_MIN 60U
#define DESKMON_CONFIG_MIN_WEATHER_REFRESH_MIN 5U
#define DESKMON_CONFIG_MAX_WEATHER_REFRESH_MIN 360U
...
typedef enum {
  ...
  DESKMON_CONFIG_ERR_WEATHER_REFRESH_INTERVAL,
  DESKMON_CONFIG_ERR_NTP_SERVER,
  DESKMON_CONFIG_ERR_TIMEZONE,
...
typedef struct {
  ...
  char ntp_server[DESKMON_CONFIG_NTP_SERVER_MAX_LEN + 1];
  char timezone[DESKMON_CONFIG_TIMEZONE_MAX_LEN + 1];
  uint32_t carousel_interval_sec;
  uint32_t sensor_read_interval_sec;
  uint32_t weather_refresh_interval_min;
